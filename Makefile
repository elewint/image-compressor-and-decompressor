...
# 			by: Eli Intriligator (eintri01) and Max Behrendt (mbehre01)
...
40image-6: 40image.o a2plain.o uarray2.o a2blocked.o uarray2b.o colorspace.o \
						quantize.o codeword.o bitpack.o dctrans.o compress40.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
